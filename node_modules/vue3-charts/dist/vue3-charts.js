...
const getCol = curry$1((col, df) => {
    if (is$1(Number)) {
        return uniq$1(map$2((v) => nth$1(col, v) || '', df)).filter((x) => x !== '');
    }
    ...
    setup(props) {
        ...
        const resizeObserver = new ResizeObserver(entries => {
            ...
            for (const entry of entries) {
                if (entry.target === ((_a = axBottomEl.value) === null || _a === void 0 ? void 0 : _a.$el)) {
                    axisSpace.y = entry.contentRect.height;
                }
                else if (entry.target === ((_b = axLeftEl.value) === null || _b === void 0 ? void 0 : _b.$el)) {
